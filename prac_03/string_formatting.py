...
# Using f-string formatting to produce the output: 1922 Gibson L-5 CES for about $16,035!
...
# 100
# 150
# Using a for loop with the range function and string formatting to produce the right-aligned output
